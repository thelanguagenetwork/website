        ...
        <div className='flex flex-col lg:flex-row w-full lg:w-11/12'>
            <div class="hidden lg:block p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <h1 class="title-font text-xl font-medium mb-3" style={{ color: '#13bfab' }}>Introduction to German</h1>
                    ...
                    <a href='https://drive.google.com/file/d/1EXZKo44czwShKBEvPnUnpJOruUUbJaAZ/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="hidden lg:block p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/13BYhxLRJecHmoA6JOpTYpZBe39VPqJrv/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="hidden lg:block p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1_WVfI7JEW8SuvU4vYWhSKzdz_BDSjAZ4/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="hidden lg:block p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1uWSj_UIMESsC9PFA-2StxpwPs-yivcxC/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
