...
export default function Levels() {
    return (<Swiper className='levelSwiper h-full' spaceBetween={5} loop={true} loopFillGroupWithBlank={true}
        breakpoints={{
            640: {
                slidesPerView: 1
        ...
        <SwiperSlide style={{ alignItems: 'flex-start' }}>
            <div className="p-2 lg:h-[95%] w-full">
                <div className="h-full  rounded-lg border-2 border-[#13bfab30] flex flex-col relative overflow-hidden">
                    ...
                    <div className='px-3 pt-10'>
                        <p className="flex items-start text-left text-gray-600 mb-3 text-sm">
                            <span className="w-4 h-4 mr-2 mt-[0.150rem] inline-flex items-center justify-center bg-[#13BFAB] text-white rounded-full flex-shrink-0">
        ...
        <SwiperSlide style={{ alignItems: 'flex-start' }}>
            <div className="p-2 lg:h-[95%] w-full">
                <div className="h-full rounded-lg border-2 border-[#13bfab5c] flex flex-col relative overflow-hidden">
        ...
        <SwiperSlide style={{ alignItems: 'flex-start' }}>
            <div className="p-2 lg:h-[95%] w-full">
                <div className="h-full rounded-lg border-2 border-[#13bfab99] flex flex-col relative overflow-hidden">
        ...
        <SwiperSlide style={{ alignItems: 'flex-start' }}>
            <div className="p-2 lg:h-[95%] w-full">
                <div className="h-full rounded-lg border-2 border-[#13bfabc7] flex flex-col relative overflow-hidden">
        ...
        <SwiperSlide style={{ alignItems: 'flex-start' }}>
            <div className="p-2 lg:h-[95%] w-full">
                <div className="h-full rounded-lg border-2 border-[#13bfab] flex flex-col relative overflow-hidden">
