...
export default function OperationIntern() {
    return (
        <div>
            ...
            <div className="px-8 lg:px-28">
                ...
                <ul class="list-disc px-10 space-y-2 text-slate-700 pt-6">
                    <li>Monitor ongoing sessions


                    </li>
                    <li>Facilitate our instant review feature to students
            ...
            <div className="px-8 lg:px-28 pt-10">
                ...
                <ul class="list-disc px-10 space-y-2 text-slate-700 pt-6">
                    ...
                    <li>Client relationship
                    </li>
                    <li>English Proficiency (Spoken & Written)
                    </li>
