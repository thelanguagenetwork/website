    ...
    <div>
      ...
      <div className="px-8 lg:px-28">
        ...
        <ul class="list-disc px-10 space-y-2 text-slate-700 pt-6">
          <li>Intensely generating leads and following up with prospects.</li>
          <li>Diligently communicating and priming the leads through channels like email, WhatsApp & calls.</li>
          <li>Initiating telephonic conversations with potential prospects.</li>
          <li>Carry out the sales process to attract new clients & maintain fruitful relationships with them and address their needs effectively.</li>
          <li>Research and identify new market opportunities.</li>
          <li>Assist the organisation’s sales and growth efforts by contributing to new customer acquisition.</li>
          <li>Achieving the weekly targets in a high pressure performance driven environment.</li>
        </ul>
      </div>
      ...
      <div className="px-8 lg:px-28 pt-10">
        ...
        <ul class="list-disc px-10 space-y-2 text-slate-700 pt-6">
          <li>Students pursuing their undergrad.</li>
          <li>Students studying in junior college</li>
          <li>Freshers.
          </li>
      ...
      <div className="px-8 lg:px-28 pt-10">
        ...
        <div className="flex flex-col space-y-5 px-4">
          <div className="flex flex-row items-center space-x-2">
            <AiFillStar className="text-xl text-[#13BFAB] justify-center mr-2" /> High performance linked rewards
