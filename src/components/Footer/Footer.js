...
export default function Footer() {
    return (
        <div className="bg-[#f4f8fb]" style={{ bottom: '0px', left: '0px' }}>
            <div className=" px-10 bg-#dfdfdf space-y-1 flex flex-col items-center pb-20">
                <span className='mt-5 flex flex-col text-2xl lg:text-5xl font-medium'>We're here to help</span>
                <br></br>
                <span className='text-md lg:text-xl mb-10'>Get in touch with our student support team for any queries or specific needs.</span>
                <br></br>
